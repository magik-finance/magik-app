...
import { ColorfulLayer } from 'components/colorful-layer'
    ...
    >
      ...
      <div className="relative flex flex-col text-white">
        ...
        <input
          ...
          className={clsx(
            'px-6 py-3 md:px-8 md:py-4 mt-3 text-sm md:text-lg font-medium text-white border-none rounded-lg placeholder:text-white bg-gradient-to-r from-gray-800 to-gray-900',
            {
              'ring-2 ring-red-600 focus:ring-2 focus:ring-red-700':
                !!errors.email,
            }
        ...
        <button type="submit" className="relative w-full mt-3 rounded-lg group">
